...
class App extends Component {
  ...
  toggleOrientation () {
    this.setState({orientation: this.state.orientation === 'vertical' ? 'horizontal' : 'vertical'})
  }
    ...
    return (
      <div>
        <FlipPage
          ...
          uncutPages={this.state.uncutPages}
        ...
        <div style={{textAlign: 'center'}}>
          <button onClick={() => this.toggleOrientation()}>
            Switch orientation (now is {this.state.orientation})
          </button>
